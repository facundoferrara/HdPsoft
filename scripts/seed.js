...
const FIGHTERS_RAW = [
  // Cruz del Sur
  { name: 'Leonor Natalini',              club: 'Cruz del Sur',     tier: 'boffer', role: 'both' },
  { name: 'Andrés Eylenstein',            club: 'Cruz del Sur',     tier: 'acero',  role: 'both' },
  { name: 'Tomás Ezequiel Celedón',       club: 'Cruz del Sur',     tier: 'acero',  role: 'both' },
  { name: 'Marcos Ayala Lao',             club: 'Cruz del Sur',     tier: 'acero',  role: 'both' },
  { name: 'Facundo Ferrara',              club: 'Cruz del Sur',     tier: 'acero',  role: 'both' },
  { name: 'Cristian Adrián Yaniz',        club: 'Cruz del Sur',     tier: 'acero',  role: 'both' },
  { name: 'Lautaro Antonio',              club: 'Cruz del Sur',     tier: 'boffer', role: 'judge' },
  { name: 'Thiago Soria',                 club: 'Cruz del Sur',     tier: 'boffer', role: 'both' },
  { name: 'Teo Campoy',                   club: 'Cruz del Sur',     tier: 'boffer', role: 'both' },
  { name: 'Juan Pedro Costa Vilardebó',   club: 'Cruz del Sur',     tier: 'boffer', role: 'judge' },
  // FadW
  { name: 'Raiquen Rodríguez',            club: 'FadW',             tier: 'acero',  role: 'both' },
  { name: 'Facundo Emiliano Pepe Schell', club: 'FadW',             tier: 'acero',  role: 'both' },
  { name: 'Néstor Torres',                club: 'FadW',             tier: 'acero',  role: 'both' },
  { name: 'Fabian Vilariño',              club: 'FadW',             tier: 'acero',  role: 'both' },
  { name: 'Roberto Taschuk',              club: 'FadW',             tier: 'acero',  role: 'both' },
  { name: 'Santiago Martinez',            club: 'FadW',             tier: 'acero',  role: 'both' },
  { name: 'Enrique Sueiro',               club: 'FadW',             tier: 'acero',  role: 'both' },
  // Sol del Norte
  { name: 'Sebastián Ferrara',            club: 'Sol del Norte',    tier: 'boffer', role: 'both' },
  // Vincere (incluye "Academia Vincere")
  { name: 'Gerónimo Hernán Videla Toteda', club: 'Vincere',         tier: 'acero',  role: 'referee' },
  { name: 'Julieta Virginia Ramos',       club: 'Vincere',          tier: 'acero',  role: 'judge' },
  { name: 'Martín Bianchi',               club: 'Vincere',          tier: 'acero',  role: 'referee' },
  { name: 'Martin Stead',                 club: 'Vincere',          tier: 'acero',  role: 'both' },
  { name: 'Gonzalo Fernandez',            club: 'Vincere',          tier: 'acero',  role: 'referee' },
  { name: 'Nicolas Gabriel Ramos',        club: 'Vincere',          tier: 'acero',  role: 'referee' },
  { name: 'Juan Cruz Rodríguez',          club: 'Vincere',          tier: 'nylon',  role: 'judge' },
  { name: 'Cristian Scotti',              club: 'Vincere',          tier: 'acero',  role: 'judge' },
  // SMCD
  { name: 'Joaquín Bentancur Flores',     club: 'SMCD',             tier: 'acero',  role: 'judge' },
  { name: 'Joaquin Wohler',               club: 'SMCD',             tier: 'acero',  role: 'both' },
  // Duelist Academy
  { name: 'Hector Balbuzano',             club: 'Duelist Academy',  tier: 'acero',  role: 'both' },
  { name: 'Katia Daniela Cristóstomo Ramos', club: 'Duelist Academy', tier: 'boffer', role: 'judge' },
]
